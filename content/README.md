...
| ------------------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| https://api.testnet.wudder.tech/graphql | testnet | This endpoint is freely available. Usage restrictions apply. <br><br> Use this endpoint if you are a free user or you are integrating our product. <br><br> The content of the traces may be deleted after a short period of time. <br><br> The Ethereum proofs are generated once a day. |
| https://api.wudder.tech/graphql   | mainnet | This endpoint is only available for paid users. <br><br> Use this endpoint if you have already performed the integration. <br><br> The content of the traces will persist. <br><br> The Ethereum proofs are generated every hour.                                                         |
